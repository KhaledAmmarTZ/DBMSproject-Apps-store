      ...
      <div class="col-12">
        <nav class="main-nav">
          ...
          <ul class="nav">
            ...
            <li><a href="admin1/adhome.php">Home</a></li>
          </ul>
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if (file_exists($imageFilePath)) {
        echo '<a href="prod.php?product_id=' . $row['product_id'] . '"><img src="' . $imageFilePath . '" alt="Product Image"></a>';
    } else {
    ...
    echo '<a href="prod.php?product_id=' . $row['product_id'] . '"><i class="fa fa-shopping-bag"></i></a>';
    ...
    <div class="row">
      ...
      <?php
        ...
        while ($row = mysqli_fetch_assoc($topDownloadsResult)) {
          ...
          $imageFilePath = "image/" . $row['image'];
          if (file_exists($imageFilePath)) {
            echo '<a href="prod.php?product_id=' . $row['product_id'] . '"><img src="' . $imageFilePath . '" alt=""></a>';
          } else {
            echo 'Image file not found.';
          }
          echo '</div>';
		  ...
		  echo '<a href="prod.php?product_id=' . $row['product_id'] . '">Explore</a>';
