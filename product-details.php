        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($productDetails)) {
                    ...
                    echo '<span class="breadcrumb"><a href="shop.php">Home</a>  >  <a href="shop.php">Shop</a>  >  ' . $productDetails['app_name'] . '</span>';
                } else {
                    echo '<h3>Product Not Found</h3>';
                    echo '<span class="breadcrumb"><a href="shop.php">Home</a>  >  <a href="shop.php">Shop</a>  >  Not Found</span>';
                }
                ?>
            </div>
        </div>
  ...
  <div class="single-product section">
    ...
    <div class="left-image">
        ...
        <div class="col-lg-6 align-self-center">
          ...
          <p>About This app:<?php echo isset($productDetails) ? $productDetails['description'] : 'Product Not Found'; ?></p>
		  <p><span>Downloads:</span><?php echo isset($productDetails) ? $productDetails['download_count'] : 'Product Not Found'; ?></p>
          <form id="qty" action="login.php">
            
            <button type="submit"><i class="fa fa-shopping-bag"></i> Download</button>
          </form>
          <ul>
...
<?php
 ...
 <div class="section most-played">
  ...
  <footer>
    <div class="container">
      <div class="col-lg-12">
        <p>Copyright © 2048 Blues Gaming Company. All rights reserved. &nbsp;&nbsp; <a rel="nofollow" href="https://templatemo.com" target="_blank">Design: khaleds</a></p>
      </div>
    </div>
  </footer>
