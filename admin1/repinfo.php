...
if (isset($_GET['search_product_id'])) {
    ...
    $query = "SELECT product.image,
                  ...
                  customer.usernam 
          FROM product
          JOIN report ON product.product_id = report.product_id
          JOIN customer ON report.customer_id = customer.customer_id
          WHERE customer.customer_id = '$search_product_id' OR product.product_id = '$search_product_id' OR report.report_id='$search_product_id'";
...
<body>
	...
	<div class="features">
		<div class="container">
			<div class="row">
				<div class="item">
				 <h4>See All Report Information</h4>
					<?php
						...
						<div class="search-container">
							<form method="get" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
								<input type="text" name="search_product_id" placeholder="Search by Pro,Cus,REP ID">
							...
							<table class="data-table table table-bordered">
								...
								<tbody>
									...
									while ($row = mysqli_fetch_assoc($result)) {
										...
										echo "<td style='color: black;'>" . htmlspecialchars($row['report_id']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['usernam']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['bug']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['crash']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['performance']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['additionalComments']) . "</td>";
