...
if (isset($_GET['search_product_id'])) {
    ...
    $query = "SELECT image, product_id, app_name, categoryname, release_date, developer_id, version, price, trating, treviews, download_count, total_sold, description FROM product WHERE product_id = '$search_product_id'";
    ...
    $query = "SELECT image, product_id, app_name, categoryname, release_date, developer_id, version, price, trating, treviews, download_count, total_sold, description FROM product";
    $result = mysqli_query($con, $query);
...
<body>
	...
	<div class="features">
		<div class="container">
			<div class="row">
				<div class="item">
				 <h4>See All Product Information</h4>
					<?php
						...
						<div class="search-container">
							<form method="get" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
								<input type="text" name="search_product_id" placeholder="Search by Product ID">
							...
							<table class="data-table table table-bordered">
								...
								<tbody>
									...
									while ($row = mysqli_fetch_assoc($result)) {
										...
										echo "<td style='color: black;'>" . htmlspecialchars($row['categoryname']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['release_date']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['version']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['description']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['price']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['treviews']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['trating']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['download_count']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['total_sold']) . "</td>";
