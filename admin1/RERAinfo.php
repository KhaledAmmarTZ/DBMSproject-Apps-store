...
if (isset($_GET['search_product_id'])) {
    ...
    $query = "SELECT product.image,
          ...
          WHERE customer.customer_id = '$search_product_id' OR product.product_id = '$search_product_id' OR review,review_id='$search_product_id'";
					...
					<?php
						...
						<div class="search-container">
							<form method="get" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
								<input type="text" name="search_product_id" placeholder="Search by Pro,Cus,REV ID">
							...
							<table class="data-table table table-bordered">
								...
								<tbody>
									...
									while ($row = mysqli_fetch_assoc($result)) {
										...
										echo "<td style='color: black;'>" . htmlspecialchars($row['review_id']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['usernam']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['rating']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['comment']) . "</td>";
										echo "<td style='color: black;'>" . htmlspecialchars($row['review_date']) . "</td>";
