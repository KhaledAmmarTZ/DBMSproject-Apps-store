                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <div class="logo" onclick="toggleOverlay()">
							...
							<div id="overlay">
							<button onclick="navigateToPage('cusdi.php')">Customer Information</button>
							<button onclick="navigateToPage('devdi.php')">Developer Information</button>
							...
							<button onclick="navigateToPage('adhome.php')">back</button>
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="adhome.php" class="active">Home</a></li>
                            <li><a href="../shopUp.php" class="active">Shop</a></li>
                            <li><a href="ainfo.php" class="active">User Info</a></li>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="caption header-text">
                        ...
                        $sql = "SELECT admin_id, email, phonenumber FROM admin WHERE admin_id=?";
                ...
                <div class="col-lg-4 offset-lg-2">
                    <div class="right-image">
                        ...
                        if (file_exists($imageFilePath)) {
                            echo '<img src="' . $imageFilePath . '" alt="Admin Image">';
                        } else {
