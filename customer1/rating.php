...
if (isset($_GET['product_id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $checkTransactionQuery = "SELECT * FROM transaction WHERE customer_id = '$customer_id' AND product_id = '$product_id'";
        $transactionResult = mysqli_query($con, $checkTransactionQuery);

        if (mysqli_num_rows($transactionResult) > 0) {
            // Customer has purchased the product, allow them to submit the review
            ...
            // Customer has not purchased the product, notify them
            echo "You must purchase the product before giving a rating and review.";
        }
    }
...
<head>
    ...
    <style>
		...
		.user-review .rating {
			color: #007BFF; /* Set selected star color to blue */
		}
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    if (isset($productDetails)) {
                        ...
                        echo '<span class="breadcrumb"><a href="#">Shop</a>   >  <a href="#">Rating and Review</a> >  ' . $productDetails['app_name'] . '</span>';
                    } else {
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="product-details">
						...
						if (isset($productDetails['trating'])) {
							echo '<div class="rating rate">' . displayStarRatingg($productDetails['trating']) . '</div>';
						}
						?>
                    </div>
...
<?php
	...
	function displayStarRatingg($rating)
	{
		$output = '';
                            ...
                            <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                <?php foreach ($reviews as $review) : ?>
                                    <div class="user-review">
                                        <p><strong><?php echo getCustomerName($review['customer_id']); ?></strong></p>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="left-text">
                        ...
                        <p>This Project are Done by Hard work . This template is used for DBMS project. Thank you.</p>
						<h6>Please give 5 STAR rating</h6>
                        <ul>
                            <li><span>Address</span> Premier University, Chittagong</li>
                            <li><span>Phone</span> +8801********</li>
                            <li><span>Email</span> khaledammar@gmail.com</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form id="contact-form" action="" method="post" onsubmit="return validateForm()">
                                        ...
                                        <div class="col-lg-12">
                                            <fieldset>
                                                <button type="submit" id="form-submit" class="orange-button">Submit Review</button>
                                            </fieldset>
                                        </div>
	...
	function displayStarRating($rating)
	{
		...
		for ($i = 1; $i <= 5; $i++) {
			$starClass = ($i <= $rating) ? 'fas fa-star star-ratingg' : 'far fa-star'; // Add 'star-ratingg' class for colored stars
			$output .= '<span class="' . $starClass . '" style="margin-right: 5px;"></span>'; // Adjust margin-right as needed
		}
    ...
    <footer>
        <div class="container">
            <div class="col-lg-12">
                <p>Copyright © Blue Gaming Company. All rights reserved. &nbsp;&nbsp;  >Design: khaled</a></p>
            </div>
        </div>
    </footer>
