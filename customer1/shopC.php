      ...
      <div class="col-12">
        <nav class="main-nav">
          ...
          <ul class="nav">
			...
			<?php echo "ID: {$_SESSION['customer_id']}";?></li>
    ...
    <div class="container">
		...
		<?php
			...
			if (file_exists($imageFilePath)) {
				echo '<a href="product-detailsC.php?product_id=' . $row['product_id'] . '"><img src="' . $imageFilePath . '" alt="Product Image"></a>';
			} else {
			...
			echo '<a href="download.php?product_id=' . $row['product_id'] . '"><i class="fa fa-shopping-bag"></i></a>';
